...
public class IMPSCNColorPoint:SCNNode{
    ...
    open func colorPosition(color newValue:NSColor) -> SCNVector3 {
        let c = newValue.rgb
        let v = SCNVector3(x:CGFloat(c.x-0.5)*2,y:CGFloat(c.y-0.5)*2,z:CGFloat(c.z-0.5)*2)
        return v
    }
    ...
    public var color:NSColor {
        set{            
            ...
            self.material.reflective.contents = newValue
        }
        get {
    ...
    public var material:SCNMaterial = SCNMaterial() {
        didSet{
